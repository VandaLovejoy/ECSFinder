...
struct gengetopt_args_info
{
  ...
  char ** shape_arg;	/**< @brief Use SHAPE reactivity data to guide structure predicitons =file1,file2.  */
  char ** shape_orig;	/**< @brief Use SHAPE reactivity data to guide structure predicitons =file1,file2 original value given at command line.  */
  unsigned int shape_min; /**< @brief Use SHAPE reactivity data to guide structure predicitons =file1,file2's minimum occurreces */
  unsigned int shape_max; /**< @brief Use SHAPE reactivity data to guide structure predicitons =file1,file2's maximum occurreces */
  const char *shape_help; /**< @brief Use SHAPE reactivity data to guide structure predicitons =file1,file2 help description.  */
  char * shapeMethod_arg;	/**< @brief Specify the method how to convert SHAPE reactivity data to pseudo energy contributions =D[mX][bY].  */
  char * shapeMethod_orig;	/**< @brief Specify the method how to convert SHAPE reactivity data to pseudo energy contributions =D[mX][bY] original value given at command line.  */
  const char *shapeMethod_help; /**< @brief Specify the method how to convert SHAPE reactivity data to pseudo energy contributions =D[mX][bY] help description.  */
  int seed_with_pID_flag;	/**< @brief Seed with process ID (default=off) (default=off).  */
  const char *seed_with_pID_help; /**< @brief Seed with process ID (default=off) help description.  */
  int print_seeds_flag;	/**< @brief Print seed values  (default=off) (default=off).  */
  const char *print_seeds_help; /**< @brief Print seed values  (default=off) help description.  */
  char ** read_seeds_arg;	/**< @brief set seed value(s) ={seed1(,seed2)}.  */
  char ** read_seeds_orig;	/**< @brief set seed value(s) ={seed1(,seed2)} original value given at command line.  */
  unsigned int read_seeds_min; /**< @brief set seed value(s) ={seed1(,seed2)}'s minimum occurreces */
  unsigned int read_seeds_max; /**< @brief set seed value(s) ={seed1(,seed2)}'s maximum occurreces */
  const char *read_seeds_help; /**< @brief set seed value(s) ={seed1(,seed2)} help description.  */
  int sci_flag;	/**< @brief Calculate SCI (default=off).  */
  const char *sci_help; /**< @brief Calculate SCI help description.  */
  ...
  unsigned int seed_with_pID_given ;	/**< @brief Whether seed_with_pID was given.  */
  unsigned int print_seeds_given ;	/**< @brief Whether print_seeds was given.  */
  unsigned int read_seeds_given ;	/**< @brief Whether read_seeds was given.  */
